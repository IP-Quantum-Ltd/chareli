...
Rules:
- The four section titles are fixed. Do not rename, reorder, or add sections: Overview, How to Play, Strategy, FAQ.
- Controls, gameplay instructions, and rules belong ONLY in the "How to Play" section goals.
...
Return ONLY valid JSON with exactly these four sections in order (fill in the goals, do not change the titles):
{{"sections": [{{"title": "Overview", "goals": ["string"]}}, {{"title": "How to Play", "goals": ["string"]}}, {{"title": "Strategy", "goals": ["string"]}}, {{"title": "FAQ", "goals": ["string"]}}], "estimated_word_count": int, "formatting_requirements": ["list"]}}"""},
            ],
