...
export default function EditCategory() {
  ...
  if (isLoading) {
    return (
      <div className="p-8 flex justify-center items-center">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#6A7282]" />
      </div>
    );
  }
  ...
  return (
    <div className="p-8 flex flex-col gap-6 max-w-3xl">
      ...
      <h1 className="text-2xl font-worksans text-[#121C2D] dark:text-white m-0">
      ...
      >
        {({ isSubmitting }) => (
          <Form className="flex flex-col gap-6 font-dmmono">
            <div>
            ...
            <div>
              <Label htmlFor="description" className="text-base mb-1">
                Description
              </Label>
              <Field
                as="textarea"
            ...
            <div>
              <div className="flex items-baseline justify-between">
                <Label htmlFor="introText" className="text-base mb-1">
                  Intro Text
                </Label>
                <IntroWordCount />
              </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-[#6A7282] dark:text-gray-400 font-worksans">
                ...
                Leave blank to omit a question. {FAQ_ANSWER_MAX} characters max.
              </p>
